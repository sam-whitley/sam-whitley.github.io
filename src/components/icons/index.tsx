...
// To add a new icon, create a new function here and include it in components in social-icons/index.tsx
// Test
...
export function ProtonMail(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
